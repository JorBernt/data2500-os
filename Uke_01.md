...
#sporsmal{
    border:1px; border-style:solid; border-color:#FFFFFF; padding: 1em; background-color:#4a4a4a; font-size:20px; border-radius: 10px;
...
<img src="images\oppgave-02.png" style="width: auto; border-radius: 10px">
</div>
</div>
